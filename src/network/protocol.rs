...
pub const PROTOCOL_VERSION: u32 = 15; // v2.4.2-alpha: TOCTOU stream corruption and IP flapping fix
...
pub const TESTNET_MAGIC: [u8; 4] = *b"QT15"; // Quanta V2 Testnet (v2.4.2-alpha)
