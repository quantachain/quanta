...
pub const PROTOCOL_VERSION: u32 = 23; // v2.4.23-alpha: Mid-session unstake BFT signature hotfix
...
pub const TESTNET_MAGIC: [u8; 4] = *b"QT23"; // Quanta V2 Testnet (v2.4.23-alpha)
