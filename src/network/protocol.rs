...
pub const PROTOCOL_VERSION: u32 = 26; // v2.4.26-alpha: Network isolation and epoch pool state root fix
...
pub const TESTNET_MAGIC: [u8; 4] = *b"QT26"; // Quanta V2 Testnet (v2.4.26-alpha)
