...
export class WalletKeys {
     ...
     * @returns {WalletKeys}
     */
    static from_keypair(pk_hex, sk_hex) {
        ...
        const ret = wasm.walletkeys_from_keypair(ptr0, len0, ptr1, len1);
        if (ret[2]) {
    ...
    sign_message(message_hex) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.walletkeys_sign_message(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    get_public_key_hex() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.walletkeys_get_public_key_hex(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_private_key_hex() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.walletkeys_get_private_key_hex(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {string}
     */
    sign_transaction_hash(hash_hex) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(hash_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.walletkeys_sign_transaction_hash(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function get_address_from_pubkey(pubkey_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(pubkey_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_address_from_pubkey(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('quanta_wallet_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
