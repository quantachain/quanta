...
# Version metadata
LABEL version="3.0.3-alpha"
LABEL org.quanta.network.protocol="38"
LABEL org.opencontainers.image.title="quanta-node" \
      org.opencontainers.image.description="QuantaChain V3 node — post-quantum BFT, Falcon-512 signatures, zero-mining. v3.0.3-alpha." \
      org.opencontainers.image.version="v3.0.3-alpha" \
