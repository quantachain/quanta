...
# Version metadata
LABEL version="3.2.9-alpha"
LABEL org.quanta.network.protocol="65"
LABEL org.opencontainers.image.title="Quanta Node" \
      org.opencontainers.image.description="QuantaChain V3 node — PQC BFT, Falcon-512, X25519MLKEM768 TLS, Strict Isolation + Agent Reputation (Template 6). v3.2.9-alpha." \
      org.opencontainers.image.version="v3.2.9-alpha" \
