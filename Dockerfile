...
# ============================================================
# V3 Release for testnet testing (v2.4.12-alpha)
#
# Image : xd637/quanta-node:v2.4.12-alpha
...
# Version metadata
LABEL version="v2.4.21-alpha"
LABEL org.quanta.network.protocol="21"
LABEL org.opencontainers.image.title="quanta-node" \
      org.opencontainers.image.description="QuantaChain V2 node — post-quantum BFT, Falcon-512 signatures, zero-mining. v2.4.21-alpha." \
      org.opencontainers.image.version="v2.4.21-alpha" \
