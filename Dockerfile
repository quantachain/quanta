...
# ============================================================
# V2 Release for testnet testing (v2.2.7-alpha)
#
# Image : xd637/quanta-node:v2.2.7-alpha
...
LABEL org.opencontainers.image.title="quanta-node" \
      org.opencontainers.image.description="QuantaChain V2 node — post-quantum BFT, Falcon-512 signatures, zero-mining. v2.2.7-alpha." \
      org.opencontainers.image.version="v2.2.7-alpha" \
