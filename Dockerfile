...
# ============================================================
# V3 Release for testnet testing (v2.5.0-alpha)
#
# Image : xd637/quanta-node:v2.5.0-alpha
...
# Version metadata
LABEL version="2.4.33-alpha"
LABEL org.quanta.network.protocol="32"
LABEL org.opencontainers.image.title="quanta-node" \
      org.opencontainers.image.description="QuantaChain V2 node — post-quantum BFT, Falcon-512 signatures, zero-mining. v2.4.33-alpha." \
      org.opencontainers.image.version="v2.4.33-alpha" \
