...
# ============================================================
# V3 Release for testnet testing (v2.4.2-alpha)
#
# Image : xd637/quanta-node:v2.4.2-alpha
...
LABEL org.opencontainers.image.title="quanta-node" \
      org.opencontainers.image.description="QuantaChain V2 node — post-quantum BFT, Falcon-512 signatures, zero-mining. v2.4.0." \
